...
<table class="table table-striped table-bordered order-table">
    ...
    <?php
    echo '<input type="reset" style="float: right" class="btn btn-danger" onclick="$(\'#content\').load(\'Pages/SearchOrders.php\')" value="Back"/>';
    ?>
</div>
<script>
    var UNIQUE = '';
    $(document).ready(function(){
        ...
        $.get('Pages/PagesPHP/OrdersPHP/GetMainOrderDetails.php?id=<?php echo $ORDER_ID ?>',function(data){
