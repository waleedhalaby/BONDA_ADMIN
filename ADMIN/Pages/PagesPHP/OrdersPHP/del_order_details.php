...
<table class="table table-striped table-bordered order-table">
    ...
    <?php
    echo '<input type="reset" style="float: right" class="btn btn-danger" onclick="$(\'#content\').load(\'Pages/DeliveredOrders.php\')" value="Back"/>';
    ?>
</div>
<script>
    var UNIQUE = '';
    $(document).ready(function(){
        ...
        $.get('Pages/PagesPHP/OrdersPHP/GetDeliveredOrderDetails.php?id=<?php echo $ORDER_ID ?>',function(data){
            ...
            $('.order-table tbody').append(
                ...
                '<tr><td style="background-color: #0c5460;color:#F4F4F4;">SHIP DATE</td><td>'+order['SHIP_DATE_TIME']+'</td></tr>'+
